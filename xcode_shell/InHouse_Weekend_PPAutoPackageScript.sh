...
scheme_name="HTSecIPhone_InHouse"
# 工程中Target对应的配置plist文件名称, Xcode默认的配置文件为Info.plist
info_plist_name="HTSecIPhone-Info"
# 指定要打包编译的方式 : Release,Debug...
build_configuration="Weekend"
...
# 删除旧.xcarchive文件
rm -rf ~/Desktop/$build_configuration"|"$scheme_name-IPA_$DATE/$scheme_name.xcarchive
# 指定输出ipa路径
export_path=~/Desktop/$build_configuration"|"$scheme_name-IPA_$DATE
# 指定输出归档文件地址
